  ...
  return (
    ...
    >
      <motion.div 
        ...
        className="bg-white/10 border border-white/20 rounded-2xl p-8 w-full max-w-md shadow-2xl flex flex-col items-center relative overflow-hidden min-h-[350px]"
      >
        <AnimatePresence mode="wait">
          {!showProgressPrompt ? (
            ...
            >
              <h2 className="text-xl font-medium text-white mb-2 text-center">{task.title}</h2>
              <p className="text-white/50 text-sm mb-8">Focus Session</p>
              ...
              <button
                onClick={handleDone}
                className="mt-4 w-full py-3 rounded-xl bg-white text-black font-medium flex items-center justify-center gap-2 hover:bg-white/90 transition-colors"
              >
